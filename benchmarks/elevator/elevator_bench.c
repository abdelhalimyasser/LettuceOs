...
int main(void)
{
    ...
    const LettuceCapabilityHandle capability =
        lettuce_capability_create(10u, 20u, 7u, LETTUCE_CAP_CALL | LETTUCE_CAP_CRITICAL, 300u);
    ...
    printf("elevator total_elapsed_ns=%" PRIu64 " ns_per_call=%" PRIu64 " ops_per_sec=%0.2f\n",
